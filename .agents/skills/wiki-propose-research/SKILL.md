---
name: wiki-propose-research
status: active-foundation
description: |
  Select a single ResearchFlow / PaperBite analysis note as a Proposal(wiki_update) — for when retrieve cascade isn't needed.
...
```bash
PYTHONPATH=src python3 -m omni_hub.cli wiki-propose-research [--help]
```
